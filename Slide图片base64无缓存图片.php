...
class Slide{
    ...
    */
    ...
    private $source_pic_count = 1   ; // 原始图片库有多少张png[要求规格260x116]，从编号1开始
    /**
    * 自动删除临时资源
    */
    ...
    */
    protected function tailoring($srcFile,$picName,$tailoring_x,$tailoring_y,$PicW,$PicH){
        ...
        $this->smallPicName =  "data:image/png;base64,$image_data";
    ...
    */
    protected function merge_pic($srcFile,$smallPicName,$picName,$tailoring_x,$tailoring_y){
        ...
        // $lim_size = getimagesize(); //取得水印图像尺寸，信息
        $lim_size = getimagesize($this->smallPicName); //取得水印图像尺寸，信息
        ...
        ob_end_clean();
        $image_data = base64_encode($image_data);
        $this->bigPicName =  "data:image/png;base64,$image_data";
